...
export default class checkedcomplains extends Component {
  constructor(props) {
    super(props);
    this.getToken();
  }
  ...
  getuncheckedcomplains() {
    ...
    fetch(config.config.hostname + '/admin/viewcheckedcomplains', {
      method: 'POST',
      headers: {
        ...
        <ListItem>
          <View style={styles.container}>
            <View style={styles.content}>
              ...
              <Text rkType='primary3 mediumLine'>Action:{data.action}</Text>
              <Text rkType='primary3 mediumLine'>Admin ID:{data.adminId}</Text>
