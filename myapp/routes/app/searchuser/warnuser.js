...
export default class warnuser extends Component {
    constructor(props) {
        super(props);
        this.state = {
            text: 'Warn user',
    ...
    warnmyuser() {
        ...
        fetch(config.config.hostname + '/admin/warnuser', {
          method: 'POST',
          headers: {
    ...
    render() {
        return (
            <View>
                <Text>User Id: {appinit.data.uid}</Text>
               ...
               <Text style = {styles.submitButtonText}> Warn </Text>
            </TouchableOpacity>
            <TouchableOpacity
